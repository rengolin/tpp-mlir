...
memref.global "private" constant @__constant_2x16xf32 : memref<2x16xf32> = dense<1.000000e+00> alignment = 128
memref.global "private" constant @__constant_2x16xf64 : memref<2x16xf64> = dense<1.000000e+00> alignment = 128
memref.global "private" constant @__constant_4x16xf32 : memref<4x16xf32> = dense<2.0> alignment = 128
memref.global "private" constant @__constant_4x8xf32 : memref<4x8xf32> = dense<0.0> alignment = 128
memref.global "private" constant @__constant_non_splat : memref<2x2xf32> = dense<[[0.0, 1.0],[2.0, 3.0]]> alignment = 128
memref.global "private" constant @__constant_zero_i32 : memref<4x8xi32> = dense<0> alignment = 128
memref.global "private" constant @__constant_one_i32 : memref<4x8xi32> = dense<1> alignment = 128
memref.global "private" constant @__constant_one_i64 : memref<4x8xi64> = dense<1> alignment = 128
memref.global "private" constant @__constant_non_splat_i32 : memref<2x2xi32> = dense<[[0, 1],[2, 3]]> alignment = 128
