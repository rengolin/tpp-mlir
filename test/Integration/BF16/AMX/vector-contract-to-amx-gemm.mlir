...
// RUN: tpp-run %s -e entry --entry-point-result=void --nano-kernels --registerBlocking=32,32,32 --gemm-unroll=16,16,16 -print  --splat-to-random --init-type normal  -seed 123  > %t.2
